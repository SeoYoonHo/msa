...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %>
    ...
    <div id="header">
        <div>
            <div class="logo">
                <a href="<%=request.getContextPath()%>/"><img src="<%=request.getContextPath()%>/resource/tiles/images/logo.png" /></a>
            </div>
            <div>
    ...
    <div id="menu" class="container">
    	...
    	<li id="customerMenu">
    		...
    		<ul>
    			...
    			<li><a href="<%=request.getContextPath()%>/customer/view/retrieveCustomerList">고객 목록 조회</a></li>
    			<li class="cqrsTab"><a href="<%=request.getContextPath()%>/customer/view/retrieveCustomerListCQRS">고객 목록 조회(CQRS)</a></li>
    		</ul>
    	</li>
    	<li id="accountMenu">
