...
public class WebController {
    ...
    public String retrieveCustomerListPage() {
        return "customer/retrieveCustomerList";
    }
    
    @RequestMapping(value="/customer/view/retrieveCustomerListCQRS")
    public String retrieveCustomerListCQRSPage() {
        return "customer/retrieveCustomerListCQRS";
    }
