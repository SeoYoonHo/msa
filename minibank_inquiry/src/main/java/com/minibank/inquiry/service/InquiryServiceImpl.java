...
public class InquiryServiceImpl implements InquiryService {
    ...
    public Customer retrieveCustomerDetail(String cstmId) throws Exception {
        ...
        // 고객 정보
        customer = inquiryRepository.selectCustomer(Customer.builder()
                                                            .cstmId(cstmId)
                                                            .build());
    ...
    public List<Account> retrieveAccountList(String cstmId) throws Exception {
        ...
        accountList = inquiryRepository.selectAccountList(Account.builder()
                                                                 .cstmId(cstmId)
                                                                 .build());
     ...
     */
    @Override
    public List<Customer> selectCustomerList(String cstmId, String cstmNm, String acntNo) throws Exception {
        return inquiryRepository.selectCustomerList(cstmId, cstmNm, acntNo);
    }
